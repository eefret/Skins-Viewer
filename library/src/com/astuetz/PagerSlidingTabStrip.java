...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		wm1.getDefaultDisplay().getMetrics(metrics1);
		screenWidthPixels = metrics1.widthPixels;
		...
		wm2.getDefaultDisplay().getMetrics(metrics2);
		screenWidthPixels = metrics2.widthPixels;
